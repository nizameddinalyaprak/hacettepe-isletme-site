...
<head>
    ...
    <style>
        ...
        .header-bg {{
            width: 100%;
            background: linear-gradient(135deg, var(--hacettepe-red) 0%, var(--hacettepe-dark-red) 100%);
            padding: 50px 20px;
            text-align: center;
            color: white;
            ...
            box-shadow: 0 4px 20px rgba(172, 35, 45, 0.15);
        }}
...
<body>
    ...
    <div class="exam-container">
        <div class="tabs">
            <button type="button" class="tab-btn active" id="btn-list-tab" onclick="switchTab('list-tab', this)">
                <i class="fa-solid fa-list-check"></i> Sınav Programı Listesi
            </button>
            <button type="button" class="tab-btn highlight-plan" id="btn-plan-tab" onclick="switchTab('plan-tab', this)">
                <i class="fa-solid fa-building-user"></i> BİNA YERLEŞİM PLANI <span style="display:block; font-size: 11px; color:#d97706; margin-top:2px;">(Sınav Salonunuzu Bulun)</span>
            </button>
        </div>
    ...
    <div class="exam-modal-overlay" id="examModalOverlay">
        <div class="exam-modal">
            ...
            <div class="exam-modal-body">
                ...
                <div style="background-color: #fffbeb; border: 1px solid #fef3c7; border-radius: 8px; padding: 16px; margin-bottom: 16px; color: #b45309;">
                    <p style="margin-top: 0; margin-bottom: 8px; font-weight: 700;"><i class="fa-solid fa-clock-rotate-left"></i> Son Sınav Güncellemeleri:</p>
                    <ul style="margin: 0; padding-left: 20px; font-size: 0.95em; line-height: 1.5;">
                        <li>Final programı ve salon atamaları excel listesine göre güncellenmiştir.</li>
                        <li>Sınav programında salon isimlerine (örn: <strong>Z1, B4, K2</strong>) tıklayarak salona ait bina yerleşimindeki konumunu anında görebilirsiniz.</li>
                    </ul>
                </div>
